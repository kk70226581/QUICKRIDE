...
function ResetPassword() {
    ...
    return (
        <div className="min-h-dvh bg-[radial-gradient(circle_at_top_left,_#fef3c7,_transparent_32%),linear-gradient(135deg,_#f8fafc,_#ecfeff)] p-4 sm:grid sm:place-items-center sm:p-8">
            <Alert
